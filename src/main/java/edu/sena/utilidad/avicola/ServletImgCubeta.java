 ...
 */
package edu.sena.utilidad.avicola;
 ...
 * @author Josarta
 */
@WebServlet("/imagesCbt/*")
public class ServletImgCubeta extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!filename.isEmpty()) {
            ...
            File carpeta = new File("C:\\Imgavicola\\Fotos\\Cubetas\\"+filename);
            ...
            try {
                ...
                System.out.println("edu.sena.utilidad.avicola.ServletImg.doGet()");
            }
        }
    }
